	...
	public class SearchEndpoint
	{
		...
		public async Task<Dictionary<string, double>> GetSearchResultsAsync(SearchRequest request)
		{
            ...
            if (Api.UsingEngine.EngineName.StartsWith("gpt-"))
                throw new NotImplementedException($"{Api.UsingEngine.EngineName} does not implement search. Use ChatCompletion or refer to https://github.com/glienard/OpenAI.Net#chatgpt for details. ");
